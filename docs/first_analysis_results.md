...
Ces résultats sont une première analyse automatique du corpus dédupliqué `reports_for_coding.csv` : 15 834 reports uniques. Les marqueurs sont lexicaux et doivent être interprétés comme des indicateurs de tri, pas comme des mesures définitives. Ils servent à orienter le codage phénoménologique manuel.
...
| --- | ---: | ---: |
| Psychédéliques classiques | 4 742 | 29.95 |
| Pharmaceuticals | 2 389 | 15.09 |
| Stimulants | 1 975 | 12.47 |
| Psychédéliques phenethylamines | 1 827 | 11.54 |
| Cannabis / cannabinoïdes | 1 242 | 7.84 |
| Dissociatifs | 1 230 | 7.77 |
| Délirogènes | 1 122 | 7.09 |
| Dépresseurs / sédatifs | 1 083 | 6.84 |
| Entactogènes | 1 055 | 6.66 |
| Opioïdes | 980 | 6.19 |
...
| Marqueur | Reports | % |
| --- | ---: | ---: |
| Menace interoceptive | 10 565 | 66.72 |
| Soutien social | 7 902 | 49.91 |
| Peur de mourir | 6 688 | 42.24 |
| Déréalisation / dépersonnalisation | 6 481 | 40.93 |
| Paranoïa / menace sociale | 5 884 | 37.16 |
| Perte de contrôle | 5 310 | 33.54 |
| Intégration positive après coup | 5 282 | 33.36 |
| Intervention médicale | 4 893 | 30.90 |
| Distorsion temporelle | 3 565 | 22.51 |
...
- menace interoceptive : 83.17 % ;
- peur de mourir : 58.62 % ;
- intervention médicale : 34.86 % ;
- acceptation / surrender : 17.31 % ;
- intégration positive après coup : 37.92 %.
...
- menace interoceptive : 73.72 % ;
- peur de mourir : 51.08 % ;
- intervention médicale : 28.19 % ;
- acceptation / surrender : 21.00 % ;
- intégration positive après coup : 43.84 %.
...
- pharmaceuticals : intervention médicale 41.65 % ;
- dépresseurs/sédatifs : intervention médicale 43.03 % ;
- dépresseurs/sédatifs : acceptation / surrender 5.54 % ;
- pharmaceuticals : acceptation / surrender 8.96 %.
...
- intégration positive après coup : 40.78 % ;
